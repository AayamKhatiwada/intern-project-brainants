...
import { getFirestore, doc, getDoc, setDoc, collection, writeBatch, query, getDocs, Firestore, addDoc } from 'firebase/firestore'
...
export const createUserDocumentFromAuth = async (userAuth: firebase.User, displayName: string | null) => {
...
export const getUserData = async (uid: string) => {
    try {
        ...
        if (docSnapshot.exists()) {
            return {
                displayName: docSnapshot.data().displayName, email: docSnapshot.data().email
            };
        } else {
